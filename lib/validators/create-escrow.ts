...
export const createEscrowFormSchema = z
  .object({
    ...
    initiator_role: z.enum(['buyer', 'seller']),
    title: z.string().trim().min(1, 'Title is required').max(300),
...
export type CreateEscrowFormValues = z.infer<typeof createEscrowFormSchema>
export type CreateEscrowFormInput = z.input<typeof createEscrowFormSchema>
