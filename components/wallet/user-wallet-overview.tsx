                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <CardDescription className="mt-2">
                      Spendable and reserved balances by wallet.
                    </CardDescription>
                  </div>
                  <Badge variant="outline">{walletCount} wallet{walletCount === 1 ? '' : 's'}</Badge>
                </div>
              </CardHeader>
                  ...
                  <li key={t.id} className="flex flex-wrap items-center justify-between gap-4 px-4 py-3">
                    <div className="flex min-w-0 items-start gap-3">
                      <span className="mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-lg border bg-muted/30">
                        {t.amount >= 0 ? (
                          <ArrowDownToLine className="size-4 text-emerald-700 dark:text-emerald-400" aria-hidden />
                        ) : (
