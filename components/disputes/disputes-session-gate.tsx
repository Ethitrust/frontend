...
export function DisputesSessionGate(props: {
  title: string
  description: string
  eyebrow?: string
  ...
  const eyebrow = props.eyebrow ?? 'Trust'
      ...
      <div className={cn(e.layout.container, 'py-8 lg:py-12')}>
        ...
        <Card className="mt-10 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Dispute threads sync with live escrow negotiation on your authenticated Ethi-Trust session.
            </CardDescription>
          </CardHeader>
          <CardContent>
