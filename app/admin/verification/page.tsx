...
import { ChevronRight, FileText, CheckCircle2, AlertTriangle, AlertCircle, RefreshCw } from "lucide-react";
...
const queue: QueueItem[] = [
  {
    id: "KYB-8831",
    displayId: "TR-8829-01",
    name: "Abyssinia Coffee Exports",
    type: "Business",
    date: "Oct 24, 2023",
    risk: "High",
    legalName: "Abyssinia Specialty Coffee PLC",
    tin: "0019283746",
    address: "Bole Sub-City, Kebele 03, House No. 442, Addis Ababa, Ethiopia",
    phone: "+251 911 223344",
    established: "March 2012",
    documents: [
      { label: "TRADE LICENSE", url: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400&q=80" },
      { label: "REPRESENTATIVE", url: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=400&q=80" },
      { label: "SELFIE MATCH", url: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" }
    ],
  },
  {
    id: "KYC-4412",
    displayId: "TR-4412-02",
    name: "Dawit Yohannes",
    type: "Individual",
    date: "Oct 24, 2023",
    risk: "Low",
    legalName: "Dawit Yohannes",
  },
  {
    id: "KYB-4408",
    displayId: "TR-4408-01",
    name: "Zemen Tech Solutions",
    type: "Business",
    date: "Oct 23, 2023",
    risk: "Medium",
  },
...
export default function AdminVerificationPage() {
  const [selected, setSelected] = useState<QueueItem>(queue[0]);
      ...
      <div className="flex h-full gap-8 p-4">
        ...
        <aside className="w-[320px] shrink-0 flex flex-col h-[calc(100vh-8rem)]">
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="rounded-full bg-[#1e3a8a] px-3 py-1 text-[10px] font-bold tracking-wider text-white">24 TOTAL</span>
          </div>
        ...
        <section className="flex-1 flex flex-col h-[calc(100vh-8rem)]">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-end justify-between mb-1.5">
                        ...
                        <span className="text-[13px] font-bold text-emerald-600">98%</span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-end justify-between mb-1.5">
                        ...
                        <span className="text-[13px] font-bold text-emerald-600">Verified</span>
                      </div>
                      <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                    ...
                    <div className="pt-2 border-t border-slate-100">
                      <div className="flex items-end justify-between mb-1.5">
                        ...
                        <span className="text-[13px] font-bold text-red-600">Flagged</span>
                      </div>
                      <p className="text-[10px] leading-snug text-red-600/80">
                        Subject identified in high-frequency trading alerts.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="absolute bottom-8 right-8 flex items-center gap-4 bg-white/50 backdrop-blur-md p-2 rounded-2xl border border-white/50 shadow-lg">
            <button className="flex items-center gap-2 rounded-xl bg-white border border-slate-200 px-5 py-3.5 text-sm font-bold text-[#0a2540] hover:bg-slate-50 transition-colors shadow-sm">
              <RefreshCw className="size-4" strokeWidth={2.5} />
              Request More Info
            </button>
            <button className="rounded-xl bg-[#c52828] px-8 py-3.5 text-sm font-bold text-white hover:bg-[#a62020] transition-colors shadow-sm shadow-red-500/20">
              Reject Submission
            </button>
            <button className="rounded-xl bg-[#61ff8d] px-8 py-3.5 text-sm font-bold text-[#064e20] hover:bg-[#52e87c] transition-colors shadow-sm shadow-emerald-500/20">
              Approve Account
            </button>
          </div>
        </section>
