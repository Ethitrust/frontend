...
/**
 * BFF for `GET /api/v1/organizations/{org_id}/wallets/{wallet_id}/transactions`
...
export async function GET(
  ...
  return proxyV1GetJson(
    request,
    `/api/v1/organizations/${encodeURIComponent(org_id)}/wallets/${encodeURIComponent(wallet_id)}/transactions?${q.toString()}`,
  )
}
